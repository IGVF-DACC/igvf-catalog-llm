...
from app import app, initialize_collection_names, build_response, ask_llm, get_updated_graph
...
class TestAppInitialization:
    ...
    def test_initialize_collection_names(self):
    ...
    def test_initialize_collection_names_empty(self):
    ...
    def test_get_updated_graph(self):
    ...
    def test_get_updated_graph_empty_selection(self):
    ...
    def test_get_updated_graph_nonexistent_collection(self):
...
class TestAskLLM:
    ...
    def test_ask_llm_success(self, mock_callback, mock_chain_class, mock_get_graph, mock_select_collections):
...
class TestHealthEndpoint:
    ...
    def test_health_check_arango_error(self, client):
    ...
    def test_health_check_llm_error(self, client):
...
class TestQueryEndpoint:
    ...
    def test_query_wrong_password(self, client):
    ...
    def test_query_correct_password(self, client):
    ...
    def test_query_exception_handling(self, client):
...
# Note: Main execution tests removed as they require complex module reloading
# and the initialization logic is already covered by other tests
