...
from infrastructure.constructs.existing import catalog_llm_dev
from infrastructure.constructs.existing import catalog_llm_prod
...
config: Dict[str, Any] = {
    'pipeline': {
        'demo': {
            ...
            'existing_resources_class': catalog_llm_dev.Resources,
            'account_and_region': catalog_llm_dev.US_WEST_2,
            'tags': [
        ...
        'production': {
            ...
            'existing_resources_class': catalog_llm_prod.Resources,
            'account_and_region': catalog_llm_prod.US_WEST_2,
            'tags': [
            ],
        },
    },
...
class Common:
    ...
    project_name: str = 'igvf-catalog-llm'
